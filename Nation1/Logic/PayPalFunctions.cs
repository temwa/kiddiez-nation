...
public class NVPAPICaller
{
    ...
    public string APIUsername = "kn_api1.synergyk.com";
    private string APIPassword = "3D4YGENLPW6VZCL2";
    private string APISignature = "AFcWxV21C7fd0v3bYYYRCpSSRl31At8kzWCwJnMoSRWr4mNhgnC2SOLr";
    ...
    public bool ShortcutExpressCheckout(string amt, ref string token, ref string retMsg)
    {
        ...
        string returnURL = "http://localhost:60560/Checkout/CheckoutReview.aspx";
        string cancelURL = "http://localhost:60560/Checkout/CheckoutCancel.aspx";

        NVPCodec encoder = new NVPCodec();
        encoder["METHOD"] = "SetExpressCheckout";
        encoder["RETURNURL"] = returnURL;
        encoder["CANCELURL"] = cancelURL;
        encoder["BRANDNAME"] = "Kiddiez Nation";
        ...
        using (Nation1.Logic.ShoppingCartActions myCartOrders = new Nation1.Logic.ShoppingCartActions())
        {
    ...
    public string HttpCall(string NvpRequest)
    {
        ...
        {
            // Log the exception.
            Nation1.Logic.ExceptionUtility.LogException(e, "HttpCall in PayPalFunction.cs");
        }
